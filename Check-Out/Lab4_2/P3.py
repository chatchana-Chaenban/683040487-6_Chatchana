...
# Tester Function
# Create players
p1 = VideoGame("Nawaratimgay", "Warmock")
p2 = VideoGame("Nichilominus", "Soccerer")
...
# Fight monsters
p1.fight_monster("Goblin", 2)
p1.fight_monster("Dragon", 5)

# Collect coins directly
p2.collect_coins(50)
...
# Party creation
team = VideoGame.create_party(["Alice", "Bob"], "Doctor")
